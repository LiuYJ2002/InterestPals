...
import {collection, doc, getDoc, updateDoc, query, getDocs, orderBy, deleteDoc, where, arrayRemove} from "firebase/firestore"
      ...
      return (
          <View className='flex-1 bg-gray-200'>
              <View className='pb-2.5 bg-white flex items-center justify-center border-b border-gray-200 shadow-md z-10'>
                  <Text className='text-xl font-medium'>Your Posts</Text>
              </View>
